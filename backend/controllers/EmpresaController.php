...
use common\models\EmpresaSearch;
...
class EmpresaController extends Controller
{
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        ...
                        'allow' => true,
                        'roles' => [User::USUARIO_ISOPORTE, User::USUARIO_ADMINISTRATIVO],
                    ],
    ...
    public function actionView($id)
    {
        ...
        $searchModelPagos = new pagoSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $dataPagos = $searchModelPagos->search(Yii::$app->request->queryParams, $id, 0);
